...
type t_Main_Menu rem blyat
	title_txtID as integer rem blyat
	
	play_txtID as integer rem blyat
	play_sprID as integer rem blyat
...
function MainMenu_Create() // fuck me
